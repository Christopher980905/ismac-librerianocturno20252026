...
public class LibroServiceImpl implements LibroService{
    ...
    public Libro update(int id, Libro libro) {
        ...
        libroExistente.orElse(null).setNumeroPaginas(libro.getNumeroPaginas());
        libroExistente.orElse(null).setEdicion(libro.getEdicion());
        libroExistente.orElse(null).setIdioma(libro.getIdioma());
        libroExistente.orElse(null).setFecha_de_publicacion(libro.getFecha_de_publicacion());
        libroExistente.orElse(null).setDescripcion(libro.getDescripcion());
        libroExistente.orElse(null).setTipo_de_pasta(libro.getTipo_de_pasta());
        libroExistente.orElse(null).setIsbn(libro.getIsbn());
        libroExistente.orElse(null).setNum_ejemplares(libro.getNum_ejemplares());
